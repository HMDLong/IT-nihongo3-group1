...
class FoodReviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create food_review" do
    assert_difference('FoodReview.count') do
      post food_reviews_url, params: { food_review: { food_id: @food_review.food_id, review: @food_review.review, user_id: @food_review.user_id } }
    end
  ...
  test "should update food_review" do
    patch food_review_url(@food_review), params: { food_review: { food_id: @food_review.food_id, review: @food_review.review, user_id: @food_review.user_id } }
